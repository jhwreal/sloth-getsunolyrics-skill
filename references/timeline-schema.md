...
`alignment_summary` reports canonical lyric count, OCR anchor count, confirmed count, interpolated count, conflict-overridden count, Whisper match count, accepted DTW count, rejected-backtrack count, and confirmed ratio. Structural validity does not mean interpolated or conflict-overridden lines are accurate; review every such cue.
